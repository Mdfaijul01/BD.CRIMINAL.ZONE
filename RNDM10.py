...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100014113654980')
        return None
    if None == '3':
        os.system('xdg-open https://github.com/Faijul01')
        return None
    if None == '4':
    	os.system('xdg-open https://www.facebook.com/profile.php?id=100014113654980')
    return None
...
╚═════╝░╚═╝░╚════╝░╚═╝╚══════╝                     
                                                         \033[1;32m=====================================================================
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m AUTHOR  \033[1;91m : \033[1;95m Criminal zone 
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m FACEBOOK  \033[1;91m : \033[1;95m Bd criminal zone
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m GITHUB  \033[1;91m : \033[1;95mFaijul01
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s[b.c.z-505] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
